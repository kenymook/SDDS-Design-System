...
| Редактор темы | `editor` | Токены (цвет/шрифты/скругления), предпросмотр, проверки | Обычное; только просмотр; унаследовано/переопределено; проверка; пипетка | да | ✅ [builder-editor](screens/builder-editor.md) |
...
Модалка сущности, детали версии, пипетка цвета, уведомления, профиль, меню сброса, всплывашки — описаны в [паттернах](patterns.md); где вызываются — в спецификациях экранов.
