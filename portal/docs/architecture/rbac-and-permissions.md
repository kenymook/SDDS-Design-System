...
Права назначаются пользователю в рамках Project Membership. Один пользователь может иметь разные роли в разных проектах.
...
| Роль | Назначение |
|---|---|
| Owner | Управляет проектом, участниками, дизайн-системами и настройками |
