...
Прототип не фиксирует финальный UI, CLI-команды или API-контракт. Команда CLI на финальном экране помечена как пример синтаксиса. Экраны Onboarding, Documentation и color picker следуют дизайн-концептам из Figma (DS-BUILDER | PLAYGROUND); финальный визуальный дизайн не утверждён — см. open questions.
